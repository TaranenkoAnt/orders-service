...
public class OrderMapper {
    ...
    public MenuOrder mapToOrder(CreateOrderRequest request,
        ...
        List<MenuLineItem> menuLineItems = getMenuLinesItems(request, infos);
        ...
        return MenuOrder.builder()
                ...
                .createdBy(request.getAddress().getCity())
    ...
    private List<MenuLineItem> getMenuLinesItems(CreateOrderRequest request, List<MenuInfo> infos) {
        return infos.stream()
                .map(info -> {
